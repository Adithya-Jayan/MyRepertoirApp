...
class _ColorSchemeScreenState extends State<ColorSchemeScreen> {
  String _selectedTheme =
      'System'; // Stores the currently selected theme option (System, Light, Dark).
  Color _selectedAccentColor =
      Colors.deepPurple; // Stores the currently selected accent color.
  ...
  Future<void> _loadInitialAccentColor() async {
    ...
    final accentColorValue =
        prefs.getInt('appAccentColor') ?? _selectedAccentColor.toARGB32();
    if (!mounted) return;
  ...
  void _setTheme(String theme) {
    ...
    setState(() {
      _selectedTheme =
          theme; // Update the local state to reflect the selected theme.
    });
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 40),
                Text(context.l10n.chooseYourAccentColor),
                ...
                ElevatedButton(
                  ...
                  child: Text(context.l10n.startApp),
                ),
              ],
            ),
          ),
