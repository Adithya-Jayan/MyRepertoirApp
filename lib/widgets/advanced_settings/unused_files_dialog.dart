    ...
    return AlertDialog(
      title: Row(
        children: [
          ...
          const Text('Unused Media Details'),
        ],
      ),
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Column(
                      ...
                      children: [
                        Text(
                          '${fileInfo.fileType} • ${p.basename(fileInfo.filePath)}',
                          style: theme.textTheme.bodySmall,
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                        Text(
                          _getFileSize(fileInfo.filePath),
      ...
      return ClipRRect(
        ...
        child: io.File(fileInfo.filePath).existsSync() 
          ? Image.file(
              ...
              fit: BoxFit.cover,
              cacheWidth: 100,
              errorBuilder: (context, error, stackTrace) => _getIconForExtension(extension),
            )
